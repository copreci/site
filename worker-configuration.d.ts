/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f2cc5d752795272bf2ddd8a72df54215)
// Runtime types generated with workerd@1.20250424.0 2025-04-18 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NUXT_PUBLIC_STORYBLOK_ACCESS_TOKEN: string;
		NUXT_PUBLIC_RESEND_API_KEY: string;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NUXT_PUBLIC_STORYBLOK_ACCESS_TOKEN" | "NUXT_PUBLIC_RESEND_API_KEY">> {}
}
